...
\production{Name}{
\lit{true}  \choice \lit{false} \choice \lit{number\_field\_pred} \choice \lit{real\_pred} \\[-0.1in]
& \choice & \lit{integer\_pred} \choice \lit{integer?} \choice \lit{rational\_pred} \\[-0.1in]
