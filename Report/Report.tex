...
\item Translation: The translator flattens PVS expressions to generates an intermediate language which relies on important use of variables to allow a simple static analysis. The syntax of this language is described Figure~\ref{fig:aux-syntax}.

\item Static analysis: The intermediate language is analyzed and stripped from some of its unnecessary copies and non destructive updates using flow analysis and an enriched type system. This analysis is described with more detail in Section~\ref{staticanal}.
