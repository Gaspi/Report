...
\end{array} \right. $
\item $<\cl{array(} x \cl{)} , s > \ \longrightarrow \ < ref(m), (s_1 , s_2 \uplus (ref(m) \mapsto ( s_1(x) )_{0 \leq i < n}) ) >$\\
...
\begin{prooftree}
\AxiomC{$<[f], (f_i \mapsto s_1(x_i), s_2)> \ \longrightarrow \ <v, (s'_1, s'_2) >$}
...
\UnaryInfC{$<E[a], s> \ \longrightarrow \ <E[a'], s'>$}
\end{prooftree}
